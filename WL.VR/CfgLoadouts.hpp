class CfgLoadouts {
    ...
    class MEDICAL_ADVANCED {
        ...
        class MEDIC {
            items[] = {"ACE_tourniquet:4","ACE_fieldDressing:15","ACE_elasticBandage:20","ACE_packingBandage:20","ACE_atropine:6","ACE_morphine:8","ACE_epinephrine:8","ACE_salineIV_500:4","ACE_personalAidKit"};
        };
        class VEHICLE: MEDIC {};
    };
